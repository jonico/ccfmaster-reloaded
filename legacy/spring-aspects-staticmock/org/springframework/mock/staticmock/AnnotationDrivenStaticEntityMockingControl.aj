 ...
 *
 * Verbatim copy of org/springframework/mock/staticmock/AnnotationDrivenStaticEntityMockingControl.aj from
 ...
 */
@Deprecated
@RequiredTypes("jakarta.persistence.Entity")
public aspect AnnotationDrivenStaticEntityMockingControl extends AbstractMethodMockingControl {
	...
	@SuppressAjWarnings("adviceDidNotMatch")
	protected pointcut methodToMock() : execution(public static * (@jakarta.persistence.Entity *).*(..));
