...
public class StartCoresOnBootBean {
    ...
    public void setDelayBetweenPollMillis(int delayBetweenPollMillis) {
        Assert.isTrue(delayBetweenPollMillis >= 0, "[Assertion failed] - this expression must be true");
        this.delayBetweenPollMillis = delayBetweenPollMillis;
    }

    public void setPollCount(int pollCount) {
        Assert.isTrue(pollCount >= 0, "[Assertion failed] - this expression must be true");
