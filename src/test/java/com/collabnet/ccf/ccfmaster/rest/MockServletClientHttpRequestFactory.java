...
public class MockServletClientHttpRequestFactory implements ClientHttpRequestFactory {
    ...
    public class MockServletClientHttpRequest extends AbstractClientHttpRequest {
        ...
        /*
         * Spring 3's AbstractBufferingClientHttpRequest, which this used to extend, is
         * package-private as of Spring 6, so the buffering it provided is done here
         * instead: getBodyInternal hands out an in-memory stream and executeInternal
         * passes its contents to the existing executeInternal(headers, byte[]).
         */
        private final ByteArrayOutputStream bufferedBody = new ByteArrayOutputStream(
                                                                 1024);
        ...
        protected ClientHttpResponse executeInternal(HttpHeaders headers)
                throws IOException {
            return executeInternal(headers, this.bufferedBody.toByteArray());
        }
