...
public class LoginInfo {
    ...
    public LoginInfo(String userName, String password, String linkId) {
        Assert.hasText(userName, "[Assertion failed] - this String argument must have text; it must not be null, empty, or blank");
    ...
    public static LoginInfo projectHospitalScopeFromSystemProperties() {
        ...
        String pass = System.getProperty(HOSPITAL_PASSWORD_SYSTEM_PROPERTY,
                "seleniumhospital");
        String linkId = System.getProperty(LINKID_SYSTEM_PROPERTY, null);
        Assert.notNull(linkId, "[Assertion failed] - this argument is required; it must not be null");
        return new LoginInfo(user, pass, linkId);
    }
